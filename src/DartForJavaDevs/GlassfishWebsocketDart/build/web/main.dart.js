...
["dart.async", "dart:async", , P, {
  ...
  }, null, "call$2", "call$1", "_nullErrorHandler$closure", 2, 2, 6, 22],
  ...
  _Future: {
    ...
    }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 6, 22],
    $isFuture: 1,
...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    ws = W.WebSocket_WebSocket("ws://localhost:8080/gfdart2/clock", null);
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, "open", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure(output)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = H.setRuntimeTypeInfo(new W._EventStream(ws, "message", false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new F.main_closure0(output)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "^": "Closure:2;output_0",
    call$1: function($event) {
      this.output_0.textContent = "Connected";
    }
  },
  main_closure0: {
    "^": "Closure:2;output_1",
    call$1: function($event) {
      this.output_1.textContent = J.get$data$x($event);
    }
  }
},
1],
